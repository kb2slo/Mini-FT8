...
| `rfcs/` | Long specs. Extract/style/boundaries: [0002](rfcs/0002-extract-and-boundaries.md). BLE companion: [0001](rfcs/0001-ble-companion.md) (RAM measurement is a Phase 1 gate). M32 Pocket + CTS time: [0003](rfcs/0003-m32-pocket-port-and-ble-time.md) (B15 on ADV; I17 parked on USB-host proof). Roadmap only links them. |
