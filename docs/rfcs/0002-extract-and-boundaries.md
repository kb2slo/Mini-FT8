...
One open slice at a time. **No open extract.** C (`ft8_lib`) is parked, not dropped. Campaign §2.3 (vendor pin) waits on C. B7 (non-blocking FATFS) is after Station/QSO browse have a module to move.
